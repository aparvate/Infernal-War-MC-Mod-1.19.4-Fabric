...
public class InfernalWarArmorItem
extends Item
implements Wearable {
    ...
    public static final DispenserBehavior DISPENSER_BEHAVIOR = new ItemDispenserBehavior(){
        ...
        protected ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
            return InfernalWarArmorItem.dispenseArmor(pointer, stack) ? stack : super.dispenseSilently(pointer, stack);
        }
    };
    ...
    public InfernalWarArmorItem(ArmorMaterial material, EquipmentSlot slot, Item.Settings settings) {
